...
roi = 285 # roi line position
deviation = 3  # the constant that represents the object counting area

speed.cumulative_object_counting_y_axis(input_video, detection_graph, category_index, is_color_recognition_enabled, roi, deviation) # counting all the objects
